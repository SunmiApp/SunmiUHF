 ...
 */
class HandleRebootDialog : BaseDialogFragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.dialog_handle_reboot, container, false)
    }
    ...
    companion object {
        fun newInstance(args: Bundle?) = HandleRebootDialog().apply {
            arguments = args
        }
    }
